...
nhanes_consort <- function(func_data, time) {
  ...
  # Check for the variable existence before entering cohort_define
  has_did040g <- rlang::has_name(func_data, 'did040g')
  ...
  cohort_define(
    ...
    step_0b = if_else(
      ...
      # else: func_data dataset is the_data
    ...
    # NOTE: step_0c (N=1078) is the complete dataset to enter the Mosslemi 5-step method;
    #   matches the N from main sensitivity analysis
...
study_cohorts |> 
  ...
  ggplot() + 
  geom_consort() +
  theme_consort(margin_h = 5, margin_v = 1) + 
...
nhanes_consort(sensitivity, '2001-2004')

# the main cohort
nhanes_consort(the_data, '2011-2022')
