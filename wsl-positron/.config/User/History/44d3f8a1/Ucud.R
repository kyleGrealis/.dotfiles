...
dictionary <- tibble::tribble(
  ...
  'age_groups', 'Age (grouped)',
  'ridreth1', 'Race/Hispanic origin',
  # 'ridreth3', 'Race/Hispanic origin w/ NH Asian',  # Removed see note in import file!
  'dmdeduc2', 'Education level - Adults 20+',
  'education', 'Education level - Adults 20+',
  'indhhin2', 'Annual household income',
  'income', 'Annual household income',

  # KDM Biological Age Variables:
  'kdm_bioage', 'Calculated biological age using KDM',
  'kdm_advance', 'Biological age advancement (bioage - chronological age)',
  ...
  # Other biomarkers in Robert's paper & other
  'lbxwbcsi', 'White Blood Cell (WBC) Count',
  ...
  'lbdglusi', 'Two-hour fasting glucose (OGTT) (mmol/L)',
  ...
  'duq215', 'Time since last used marijuana regularly (yrs)',  # Calculated
  # -----
  ...
  'duq220', 'Time since last used marijuana or hashish (yrs)',  # Calculated
  # -----
  ...
  'duq270', 'Time since last used cocaine (yrs)',  # Calculated
  # -----
  ...
  'duq310', 'Time since last used heroin (yrs)',  # Calculated
  # -----
  ...
  'duq350', 'Time since last used methamphetamine (yrs)',  # Calculated
  # -----
  ...
  'duq400', 'Time since you last used a needle to inject a drug (yrs)',  # Calculated
  # -----
