...
# all_drugs -----
# These data are a pain because they are so granular. I will use `tlfb instead`.
...
analysis <-
  left_join(analysis, public.ctn0094data::rbs, by = "who")
rm(rbs)
...
analysis <-
  left_join(analysis, public.ctn0094data::rbs_iv, by = "who")
rm(rbs_iv)
