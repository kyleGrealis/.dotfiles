...
Of all the individuals who were randomized in the three trials <mark>(N = 2,492), 99.4%, or all except 14 people,</mark> had _any_ drug use information either self-reported use or via urine drug screen (UDS).  Thus, the analysis cohort consisted of the <mark>2,478</mark> people where there was any information on their drug use during treatment. 
...
```{r}
#| label: tbl-two
#| tbl-cap: Feature conversion process during recipe step application
