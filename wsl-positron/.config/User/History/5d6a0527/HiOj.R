...
study_cohorts <- the_data |> 
  ...
  cohort_label(
    ...
    # Undiagnosed Type 2 (total -- unique participants)
    # undiagnosed_type2 = 'Participants with<br>undiagnosed<br>Type 2 diabetes<br>',
    # Undiagnosed Type 2 (FPG)
    # undiagnosed_type2_fpg = 'Fasting blood<br>glucose >= 126<br>',
    # Undiagnosed Type 2 (HbA1c)
    # undiagnosed_type2_hba1c = 'HbA1c<br>>=6.5<br>',
