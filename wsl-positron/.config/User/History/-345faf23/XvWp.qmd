...
diabetes <- diabetes_full |> 
  mutate(
    ...
    insulin_duration_yrs = case_when(
      ...
      year >= 2001 & year <= 2004 & did060u == 'Years' ~ did060q,
      year >= 2001 & year <= 2004 & did060u == 'Months' ~ did060q / 12,
...
diabetes |> 
  select(year, diq060g, diq060q, did060g, did060q, diq060u, did060, insulin_duration_yrs) |> 
  view()
