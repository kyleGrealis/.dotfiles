...
diabetes <- diabetes_full |> 
  mutate(
    ...
    age_told_diabetes = case_when(
      # 1999-2000: Uses DIQ prefix
      year < 2001 & diq040g == 1 ~ diq040q,
      year < 2001 & diq040g == 2 ~ 0.5,
      year < 2001 & diq040g %in% c(7, 9) ~ NA_real_,
      
      # 2001-2004: Uses DID prefix  
      year >= 2001 & year < 2005 & did040g == 1 ~ did040q,
      year >= 2001 & year < 2005 & did040g == 2 ~ 0.5,
      year >= 2001 & year < 2005 & did040g %in% c(7, 9) ~ NA_real_,
      
      # 2005+: Single variable, numeric codes
      year >= 2005 & did040 >= 1 & did040 <= 79 ~ as.numeric(did040),
      year >= 2005 & did040 == 80 ~ 80,  # "80 years or older"
      year >= 2005 & did040 == 666 ~ 0.5,  # "Less than 1 year"
      year >= 2005 & did040 %in% c(777, 999) ~ NA_real_,
