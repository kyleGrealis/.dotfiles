...
diabetes <- diabetes_full |> 
  mutate(
    ...
    age_told_diabetes = case_when(
      ...
      (year == 2001 & diq040g == 'Enter number') ~ did040q,
      (year == 2001 & diq040g == 'Less than 1 year') ~ 0.5,
      (year == 2001 & diq040g %in% c('Refused', 'Don\'t know')) ~ NA_integer_,
      (year == 2001 & is.na(diq040g)) ~ NA_integer_,
