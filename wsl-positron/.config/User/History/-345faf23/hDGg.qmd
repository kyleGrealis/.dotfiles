...
glyco <- pull_nhanes('LAB10', glyco_vars)
glyco2 <- pull_nhanes('L10', glyco_vars)
glyco3 <- pull_nhanes('GHB', glyco_vars)
glyco <- bind_rows(glyco, glyco2, glyco3)
unique(glyco$year)
...
writexl::write_xlsx(the_data, path = 'data/study_data.xlsx')
```
