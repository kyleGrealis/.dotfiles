...
diabetes <- diabetes_full |> 
  mutate(
    ...
    insulin_duration_yrs = case_when(
      ...
      year >= 2001 & year <= 2004 & did060g == 'Enter number (of months or years)' & did060u == 'Years' ~ did060q,
      year >= 2001 & year <= 2004 & did060g == 'Enter number (of months or years)' & did060u == 'Months' ~ did060q / 12,
      year >= 2001 & year <= 2004 & did060g %in% c('Refused', "Don't know") ~ NA_real_,
      year >= 2001 & year <= 2004 & is.na(did060g) ~ NA_real_,

      # For 2005+ cycles: Uses DID060 only (single variable with numeric values)
      # Need to check codebook for 2005+ structure - likely similar to DID040
      year >= 2005 & did060 == 666 ~ 0.5 / 12,  # "Less than 1 month" if code exists
      year >= 2005 & did060 >= 1 & did060 <= 100 ~ as.numeric(did060),  # Assume years
...
diabetes |> 
  select(year, diq060g, diq060q, did060g, did060q, diq060u, did060) |> 
  view()
