...
#| label: tbl-one
#| tbl-cap: !expr |
#| glue::glue("Overall model performance, measured using area under the ROC curve, when predicting failure of treatment in a training data set of {the_training_count} people seeking care for Opioid Use Disorder.")
