...
The full analysis dataset was split using a stratification algorithm that made sure that the training data (3/4 of the data, N = `r the_training_count`) and the testing data (1/4 the data, N = `r the_testing_count`) had the same percentage of people for whom treatment failed. For model tuning, five-fold cross validation was used. See the web supplement for more details.
