...
reduced <- imported |> 
  ...
  rename(
    ...
    derived_glucose_mmol = ,
    derived_ln_alp = ,
    derived_ln_crp = ,
    derived_ln_walk = ,
    derived_crp_category = ,
    derived_ln_hba1c = ,
    derived_fev1_1000 = ,
    derived_mean_blood_pressure = ,
    derived_ln_creat = ,
    derived_creat_umol = ,
    derived_grip_scaled = ,
    derived_ln_creat_umol = ,
    derived_ln_uap = ,
    derived_albumin_g_l = ,
    derived_pulse_pressure_alt = ,
    derived_nonhdl_cholesterol = ,
    derived_pulse_pressure = ,
    derived_albumin_creatinine_ratio = ,
    derived_alt_proxy = 
  )
```
