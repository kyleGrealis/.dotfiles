...
# the_cohort |>
#   filter(diabetes_class == 'Type 1 DM') |> 
#   mutate(age_grp = if_else(age_told_diabetes < 40, '< 40', '>= 40')) |> 
#   tabyl(age_grp) |> 
#   rename(`Those with Type 1 DM` = age_grp)
```
---
...
# UPDATED 10.13.2025
#            diabetes_class      n percent
#                  Controls 129282   91.8%
#  Excluded (during step 1)    123    0.1% ** had a diabetes diagnosis but removed at Step 1
#                 Type 1 DM    430    0.3%
#                 Type 2 DM   8618    6.1%
...
```{r}
extras2 <- function(tbl, pval = TRUE, overall = TRUE) {
  result <- tbl |>
    bold_labels() |> 
    modify_header(label ~ "")
