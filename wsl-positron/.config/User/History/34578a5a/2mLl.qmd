    ...
    diabetes_class = factor(
      case_when(
        ...
        (is_initially_excluded == 'include' & 
          # did040 <= 40 &  # include age at diagnosis???
          diab_duration - did060 <= 1) ~ 'Type 1 DM',
...
#        Excluded   2878    2.0%  ** had a diabetes diagnosis but removed at Step 1
#        Controls 130892   92.9%
#       Type 1 DM    307    0.2%
#       Type 2 DM   4408    3.1%
#  Undx Type 2 DM   2336    1.7%
  gt() |> 
  cols_label(
