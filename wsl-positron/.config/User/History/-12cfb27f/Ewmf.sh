...
# Copy main supplement related files
safe_cp "$ORIG_MAIN_DIR/the-new-england-journal-of-medicine.csl" .
safe_cp "$ORIG_MAIN_DIR/packages.bib" .
safe_cp "$ORIG_MAIN_DIR/references.bib" .
safe_cp "$ORIG_MAIN_DIR/callout.css" .
safe_cp "$ORIG_MAIN_DIR/styles.css" .
